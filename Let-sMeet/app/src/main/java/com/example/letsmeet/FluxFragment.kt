...
import com.example.letsmeet.onlineAPI.APIStrgService
import com.example.letsmeet.onlineAPI.APIStrgServiceAccess
import com.example.letsmeet.placeRecyclerView.PlaceAdapter
...
/*    lateinit var viewModel : PlacesStrasbourgAPIViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View?
    {
       ...
       /* val p1 = Place("Cathédrale de Strasbourg", "monument", null, null, null, null)
        ...
        APIStrgServiceAccess.getAll()

//        val arrayPlaces : ArrayList<Place> = arrayListOf(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15)
        val arrayPlaces : ArrayList<Place> = ArrayList(APIStrgServiceAccess.placesLive)

        val adapter: PlaceAdapter = PlaceAdapter()
        adapter.addPlaceList(arrayPlaces)
